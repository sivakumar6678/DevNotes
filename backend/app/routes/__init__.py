...
api_bp.add_url_rule("/technologies/<int:tech_id>", view_func=update_technology, methods=["PUT"])
api_bp.add_url_rule("/technologies/<int:tech_id>", view_func=delete_technology, methods=["DELETE"])
